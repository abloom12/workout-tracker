...
const tabsListVariants = cva(
  [
    ...
    'group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none',
  ],
  {
    variants: {
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'h-[calc(100%-1px)] rounded-md border border-transparent px-1.5 py-0.5',
        'text-foreground/60 hover:text-foreground text-sm font-medium whitespace-nowrap',
        ...
        'group-data-[variant=line]/tabs-list:bg-transparent group-data-[variant=line]/tabs-list:data-active:bg-transparent group-data-[variant=line]/tabs-list:data-active:shadow-none group-data-[variant=line]/tabs-list:data-active:after:opacity-100',
